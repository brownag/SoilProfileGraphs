...
# Load the image
img <- readPNG("inst/extdata/buttelake.png")
spc <- readRDS("inst/extdata/aecpedons.rds")[3, ]
...
spc <- trunc(spc, depth_min, depth_max)
lab <- trunc(lab, depth_min, depth_max)
...
p
p + annotation_custom(recordPlot())

ggsave("man/images/buttelake.jpg", p, device = "jpeg",
